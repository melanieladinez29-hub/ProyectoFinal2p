    ...
    <main>
        ...
        <section id="contacto" class="contacto">
            ...
            <?php if(isset($_GET['status']) && $_GET['status'] === 'success'): ?>
                <div class="correcto">¡Tu mensaje ha sido enviado e insertado con éxito!</div>
            <?php endif; ?>
            <?php if(isset($_GET['status']) && $_GET['status'] === 'error'): ?>
                <div class="error">Error: Por favor verifica los datos ingresados.</div>
            <?php endif; ?>

            <form id="formulario-contacto" action="index.php?action=contacto-enviar" method="POST" class="formulario">
                <fieldset>
